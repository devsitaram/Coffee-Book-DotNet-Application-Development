...
namespace CoffeeBook.Data.Services
{
    public static class Utils
    {
        ...
        {
            return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "User-Data");
        }
        ...
        {
            return Path.Combine(GetAppDirectoryPath(), userId.ToString() + "data.json");
        }
    }
}
